...
function DrawingToolsSidebarComponent(): JSX.Element {
  ...
  return (
    <div className="flex flex-row sm:flex-col bg-black border-r border-gray-800 py-2 px-1 sm:px-0 w-auto sm:w-10 overflow-x-auto sm:overflow-x-hidden sm:overflow-y-auto">
      {TOOLS.map((tool) => (
        <button
          key={tool.id}
