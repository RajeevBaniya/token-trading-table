  ...
  return (
    <div className="bg-black border-b border-gray-800 p-1.5 sm:p-2">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
        <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1 flex-wrap">
              <span className="font-semibold text-white text-xs sm:text-sm truncate">{token.name}</span>
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap w-full sm:w-auto justify-between sm:justify-start">
